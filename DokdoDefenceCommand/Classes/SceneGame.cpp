...
bool SceneGame::init()
{
    ...
    Label* labelLoading = LabelCreator::createLabel("Combat readiness", "Capsmall.ttf", 40);
...
void SceneGame::startGame(float dt)
{
    ...
    Label* energyLabel = LabelCreator::createLabel("5500 / 5500", "OneSlot.ttf", 20);
...
void SceneGame::updateTime(float dt)
{
    ...
    if(mDifficulty <= MENU_TAG_NORMAL)
    {
        ...
        {
            Label* tutorial = LabelCreator::createLabel(bKorean ? "무기를 선택" : "Choose your weapon", "JejuHallasan.ttf", 30);
        ...
        {
            Label* tutorial = LabelCreator::createLabel(bKorean ? "레이더 범위내를 터치하여 독도로 부터 공격" : "Touch within range", "JejuHallasan.ttf", 20);
        ...
        {
            Label* tutorial = LabelCreator::createLabel(bKorean ? "해군 전함 및 조기경보기 소환\n조기 경보기는 적 잠수함을 탐지합니다." : "Sailing orders", "JejuHallasan.ttf", 20);
        ...
        {
            Label* unit = LabelCreator::createLabel(bKorean ? "윤영하함" : "Patrol ship", "JejuHallasan.ttf", 25);
            ...
            unit = LabelCreator::createLabel(bKorean ? "이순신함" : "Frigate", "JejuHallasan.ttf", 25);
            ...
            unit = LabelCreator::createLabel(bKorean ? "장보고함" : "Submarine", "JejuHallasan.ttf", 25);
            ...
            unit = LabelCreator::createLabel(bKorean ? "피스아이" : "AWACS", "JejuHallasan.ttf", 25);
            ...
            unit = LabelCreator::createLabel(bKorean ? "세종대왕함" : "Destroyer", "JejuHallasan.ttf", 25);
            ...
            unit = LabelCreator::createLabel(bKorean ? "독도함" : "Logistic ship", "JejuHallasan.ttf", 25);
            ...
            unit = LabelCreator::createLabel(bKorean ? "전술핵폭격" : "Nuclear Weapon", "JejuHallasan.ttf", 25);
            ...
            unit = LabelCreator::createLabel(bKorean ? "F15K" : "Fighter", "JejuHallasan.ttf", 25);
...
void SceneGame::fireMissile(Vec2 origin,
                            ...
                            bool enermy)
{
    SpriteFire* missile = SpriteFire::create(TYPE_MISSILE, TARGET_ALL, damage, enermy, target);
...
void SceneGame::fireTorpedo(Vec2 origin,
                            ...
                            bool enermy)
{
    SpriteFire* torpedo = SpriteFire::create(TYPE_TORPEDO, TARGET_SEALEVEL, damage, enermy, target);
...
void SceneGame::fireBomb(Vec2 origin,
                         ...
                         bool enermy)
{
    SpriteFire* bomb = SpriteFire::create(TYPE_BOMB, TARGET_SEALEVEL, damage, enermy, target);
...
void SceneGame::fireNuclear()
{
    ...
    SpriteFire* bomb = SpriteFire::create(TYPE_NUCLEAR, TARGET_ALL, mDokdoMaxHP, false, target);
    bomb->setPosition(origin);
    bomb->setScale(2.0);
    batchAir->addChild(bomb, GAME_AIR_ZORDER_BOMB);
                           ...
                           FIRE_TARGET targetType)
{
    ...
    SpriteFire* fire = SpriteFire::create(fireType, targetType, damage, enermy, target);
...
//        if (50 < DokdoCalculator::getDistance(weapon->getPosition(), weapon->mTargetPos)) {
//            continue;
//        }
