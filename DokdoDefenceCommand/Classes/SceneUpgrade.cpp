...
bool SceneUpgrade::init()
{
    ...
    labelMoney = LabelCreator::createLabel("000000000000", "Wednesday.ttf", 28);
...
{
    Label* range = LabelCreator::createLabel("Range", "Capsmall.ttf", INFO_FONTSIZE);
    range->setAnchorPoint(Vec2(0, 0.5));
    range->setPosition(pt);
    range->setColor(DOKDO_COLOR);
    addChild(range, 2);
    
    Label* spm = LabelCreator::createLabel("SPM", "Capsmall.ttf", INFO_FONTSIZE);
    spm->setAnchorPoint(Vec2(0, 0.5));
    spm->setPosition(Vec2(pt.x, pt.y-19));
    spm->setColor(DOKDO_COLOR);
    addChild(spm, 2);
    
    Label* damage = LabelCreator::createLabel("Damage", "Capsmall.ttf", INFO_FONTSIZE);
    damage->setAnchorPoint(Vec2(0, 0.5));
    damage->setPosition(Vec2(pt.x, pt.y - (36)));
    damage->setColor(DOKDO_COLOR);
    addChild(damage, 2);
    
    Label* range2 = LabelCreator::createLabel("0", "Capsmall.ttf", INFO_FONTSIZE);
    ...
    Label* spm2 = LabelCreator::createLabel("00", "Capsmall.ttf", INFO_FONTSIZE);
    ...
    Label* damage2 = LabelCreator::createLabel("000", "Capsmall.ttf", INFO_FONTSIZE);
...
{
    Label* hp = LabelCreator::createLabel("HP", "Capsmall.ttf", INFO_FONTSIZE);
    ...
    Label* hp2 = LabelCreator::createLabel("0", "Capsmall.ttf", INFO_FONTSIZE);
    ...
    Label* range2 = LabelCreator::createLabel("00", "Capsmall.ttf", INFO_FONTSIZE);
    range2->setAnchorPoint(Vec2(1, 0.5));
    range2->setPosition(Vec2(INFO_RIGHT, range->getPosition().y));
    range2->setColor(UNIT_COLOR);
    addChild(range2, 2, tag + 201);
    
    Label* spm2 = LabelCreator::createLabel("000", "Capsmall.ttf", INFO_FONTSIZE);
    spm2->setAnchorPoint(Vec2(1, 0.5));
    spm2->setPosition(Vec2(INFO_RIGHT, spm->getPosition().y));
    spm2->setColor(UNIT_COLOR);
    addChild(spm2, 2, tag + 202);
    
    Label* damage2 = LabelCreator::createLabel("0000", "Capsmall.ttf", INFO_FONTSIZE);
    damage2->setAnchorPoint(Vec2(1, 0.5));
    damage2->setPosition(Vec2(INFO_RIGHT, damage->getPosition().y));
...
{
    Label* label = LabelCreator::createLabel("00", "Capsmall.ttf", 36);
...
Sprite* SceneUpgrade::addUpgradeBtn(const char* btn, Vec2 pt, Color3B color)
{
    ...
    Label* label = LabelCreator::createLabel("000000", "Wednesday.ttf", 28);
