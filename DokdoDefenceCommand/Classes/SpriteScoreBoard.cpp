...
void SpriteScoreBoard::addNumbers() {
    labelScore = LabelCreator::createLabel("000000000", "OneSlot.ttf", 32);
    labelScore->setPosition(Vec2(110, 57));
    addChild(labelScore);
    
    labelHighScore = LabelCreator::createLabel("000000000", "OneSlot.ttf", 22);
    labelHighScore->setPosition(Vec2(110, 12));
    addChild(labelHighScore);
    
    labelTime = LabelCreator::createLabel("00:00", "OneSlot.ttf", 21);
    labelTime->setPosition(Vec2(270, 67));
    addChild(labelTime);
    
    labelMoney = LabelCreator::createLabel("000000000", "OneSlot.ttf", 21);
