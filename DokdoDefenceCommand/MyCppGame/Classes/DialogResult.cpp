                        ...
                        bool highscore)
{
    ...
    Label* timeTitle = LabelCreater::createLabel("Time", "Capsmall.ttf", fontSize);
    ...
    Label* timeLabel = LabelCreater::createLabel(szTemp, "Capsmall.ttf", fontSize);
    timeLabel->setAnchorPoint(Vec2(1, 0));
    timeLabel->setPosition(Vec2(titleRight, 218));
    spDlg->addChild(timeLabel);
    
    Label* enermyTitle = LabelCreater::createLabel("Enermies", "Capsmall.ttf", fontSize);
    ...
    Label* enermyLabel = LabelCreater::createLabel(szTemp, "Capsmall.ttf", fontSize);
    enermyLabel->setAnchorPoint(Vec2(1, 0));
    enermyLabel->setPosition(Vec2(titleRight, 183));
    spDlg->addChild(enermyLabel);
    
    Label* ourTitle = LabelCreater::createLabel("Our troops", "Capsmall.ttf", fontSize);
    ...
    Label* ourLabel = LabelCreater::createLabel(szTemp, "Capsmall.ttf", fontSize);
    ourLabel->setAnchorPoint(Vec2(1, 0));
    ourLabel->setPosition(Vec2(titleRight, 147));
    spDlg->addChild(ourLabel);
    
    Label* scoreTitle = LabelCreater::createLabel("Score", "Capsmall.ttf", fontSize);
    ...
    Label* scoreLabel = LabelCreater::createLabel(szTemp, "Capsmall.ttf", fontSize);
    ...
    Label* revenueTitle = LabelCreater::createLabel("Revenue", "Capsmall.ttf", fontSize);
    ...
    Label* revenueLabel = LabelCreater::createLabel(szTemp, "Capsmall.ttf", fontSize);
