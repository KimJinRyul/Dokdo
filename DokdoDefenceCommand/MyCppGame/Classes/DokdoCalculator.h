...
#ifndef __DokdoDefenceCommand__DokdoCalculator__
#define __DokdoDefenceCommand__DokdoCalculator__
...
public:
    ...
    static float getDistance(cocos2d::Vec2 pt1, cocos2d::Vec2 pt2);
};

#endif /* defined(__DokdoDefenceCommand__DokdoCalculator__) */
